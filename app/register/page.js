    ...
    <div style={st.container}>
      <div style={st.card}>
        <div style={st.headerWrap}>
          ...
          <p style={st.subtitle}>Setelah daftar, tunggu guru menyetujui akun kamu</p>
        </div>
        ...
        {berhasil ? (
          ...
          <form onSubmit={handleRegister}>
            <div style={st.formGroup}>
              ...
              <input type="text" placeholder="Contoh: Budi Santoso" value={nama}
                onChange={function (e) { setNama(e.target.value) }} style={st.input} />
            </div>

            <div style={st.formGroup}>
              <label style={st.label}>Email *</label>
              <input type="email" placeholder="Contoh: budi@gmail.com" value={email}
                onChange={function (e) { setEmail(e.target.value) }} style={st.input} />
            </div>

            <div style={st.formGroup}>
              <label style={st.label}>Password *</label>
              <input type="password" placeholder="Minimal 6 karakter" value={password}
                onChange={function (e) { setPassword(e.target.value) }} style={st.input} />
            </div>

            <div style={st.formGroup}>
              <label style={st.label}>Pilih Kelas *</label>
              <select value={kelasId} onChange={function (e) { setKelasId(e.target.value) }} style={st.select}>
        ...
        {!berhasil && (
          <div style={st.linkWrap}>
            <p style={{ margin: 0, color: "#6b7280", fontSize: "14px" }}>
              Sudah punya akun?{" "}
              <span onClick={function () { router.push("/login") }} style={st.link}>Login di sini</span>
            </p>
          </div>
        )}
      </div>
...
var st = {
  container: { minHeight: "100vh", background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)", display: "flex", justifyContent: "center", alignItems: "center", padding: "24px", fontFamily: "'Segoe UI', system-ui, sans-serif" },
  card: { background: "white", padding: "40px 36px", borderRadius: "20px", width: "100%", maxWidth: "420px", boxShadow: "0 20px 40px rgba(0,0,0,0.15)" },
  headerWrap: { textAlign: "center", marginBottom: "28px" },
  title: { margin: "12px 0 8px 0", fontSize: "26px", color: "#1a1a1a" },
  subtitle: { margin: 0, fontSize: "14px", color: "#6b7280" },
  pesan: { padding: "12px 16px", borderRadius: "10px", marginBottom: "20px", fontWeight: "600", fontSize: "14px", textAlign: "center" },
  ...
  input: { width: "100%", padding: "12px 16px", border: "2px solid #e5e7eb", borderRadius: "10px", fontSize: "15px", outline: "none", boxSizing: "border-box" },
  select: { width: "100%", padding: "12px 16px", border: "2px solid #e5e7eb", borderRadius: "10px", fontSize: "15px", outline: "none", boxSizing: "border-box", background: "white" },
  submitBtn: { width: "100%", padding: "14px", background: "linear-gradient(135deg, #667eea, #764ba2)", color: "white", border: "none", borderRadius: "10px", cursor: "pointer", fontSize: "16px", fontWeight: "700", marginTop: "8px" },
  linkWrap: { textAlign: "center", marginTop: "20px" },
  link: { color: "#667eea", fontWeight: "700", cursor: "pointer", textDecoration: "underline" },
}